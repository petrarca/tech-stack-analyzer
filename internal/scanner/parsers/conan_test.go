...
func TestConanParser_ExtractDependencies(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			content: `
				self.requires("mylib_dev/2.0.0.26001")
				self.requires("libpq/10.7.1942_2")
			`,
			expected: []types.Dependency{
				{Type: "conan", Name: "mylib_dev", Version: "2.0.0.26001", Scope: "prod"},
...
func TestConanParser_parsePackagesFile(t *testing.T) {
	...
	// Test with packages file containing various version string formats
...
`
	...
	expected := []types.Dependency{
		{Type: "conan", Name: "acmecore_dev", Version: "25.4.1002.0", Scope: "prod"},
		{Type: "conan", Name: "mylib_dev", Version: "2.0.0.26001", Scope: "prod"},
		{Type: "conan", Name: "chartwidget", Version: "5.1.0.1", Scope: "prod"},
		{Type: "conan", Name: "dcmtk", Version: "3.5.4.4", Scope: "prod"},
		{Type: "conan", Name: "openssl", Version: "3.2.6", Scope: "prod"},
		{Type: "conan", Name: "sqlite3", Version: "3.49.1.0", Scope: "prod"},
		{Type: "conan", Name: "easyio", Version: "0.1.30.76402_2", Scope: "prod"},
		{Type: "conan", Name: "dbconnect", Version: "21.15.0", Scope: "prod"},
	}
...
func TestConanParser_parseConanDependency(t *testing.T) {
	...
	tests := []struct {
		...
		{
			input:    "mylib_dev/2.0.0.26001",
			expected: types.Dependency{Name: "mylib_dev", Version: "2.0.0.26001", Type: "conan", Scope: "test"},
		},
		{
