...
type SubsystemStat struct {
	...
	Techs          []string       `json:"techs,omitempty"`       // Deduplicated union of component techs in this subsystem (sorted)
	Languages      map[string]int `json:"languages,omitempty"`   // Merged language file counts from components in this subsystem
