...
- This includes: company names, internal hostnames, product names, project names, usernames, email addresses, registry URLs, and package names from private registries
- Always use clearly fictional placeholders: `example.com`, `myorg`, `myapp`, `mylib`, `MyProject`, etc.
