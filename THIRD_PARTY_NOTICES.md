...
`stack-analyzer` includes third-party open-source software. The full
license text for each component is reproduced under `third_party/licenses/`.

This file is generated — do not edit by hand. Regenerate with
`task licenses` whenever dependencies change; `task licenses:check`
...
| github.com/agext/levenshtein | Apache-2.0 | https://github.com/agext/levenshtein/blob/v1.2.1/LICENSE |
| github.com/agnivade/levenshtein | MIT | https://github.com/agnivade/levenshtein/blob/420867539855/License.txt |
...
| github.com/aquasecurity/go-version/pkg/part | Apache-2.0 | https://github.com/aquasecurity/go-version/blob/v0.0.1/LICENSE |
| github.com/aymanbagabas/go-osc52/v2 | MIT | https://github.com/aymanbagabas/go-osc52/blob/v2.0.1/LICENSE |
| github.com/bmatcuk/doublestar/v4 | MIT | https://github.com/bmatcuk/doublestar/blob/v4.10.0/LICENSE |
| github.com/boyter/gocodewalker | MIT | https://github.com/boyter/gocodewalker/blob/19676720409f/LICENSE |
| github.com/boyter/gocodewalker/go-gitignore | MIT | https://github.com/boyter/gocodewalker/blob/19676720409f/go-gitignore/LICENSE |
| github.com/boyter/scc/v3/processor | MIT | https://github.com/boyter/scc/blob/v3.7.0/LICENSE |
...
| github.com/charmbracelet/x/ansi | MIT | https://github.com/charmbracelet/x/blob/ansi/v0.8.0/ansi/LICENSE |
...
| github.com/go-enry/go-license-detector/v4/licensedb | Apache-2.0 | https://github.com/go-enry/go-license-detector/blob/v4.3.1/LICENSE.md |
...
| github.com/jdkato/prose | MIT | https://github.com/jdkato/prose/blob/v1.2.1/LICENSE |
...
| github.com/shogo82148/go-shuffle | MIT | https://github.com/shogo82148/go-shuffle/blob/v1.0.1/LICENSE.md |
